        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ backgroundColor: 'var(--bg-primary)' }}>
            ...
            <div className="w-full max-w-md animate-fade-in-up relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="mt-2 text-sm" style={{ color: 'var(--text-secondary)' }}>AI-Driven Resume-to-Role Matching</p>
                </div>
                ...
                <div className="backdrop-blur-xl border rounded-2xl p-8 shadow-2xl"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 px-4 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                            style={{
